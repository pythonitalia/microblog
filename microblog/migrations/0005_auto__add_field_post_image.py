...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('microblog_post', 'image', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.image'
        db.delete_column('microblog_post', 'image')
